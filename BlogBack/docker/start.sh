...
#授予权限
sudo chmod 777 -R /home/sql/blog

#修正文件格式,这里dos2unix的执行也需要sudo,否则会报错`Failed to change the owner and group of temporary output file /home/sql/blog/d2utmpKfjPMF: Operation not permitted`
for f in /home/sql/blog/*; do
    sudo dos2unix "$f"
done

# 确保结尾换行,避免出现错误:`new crontab file is missing newline before EOF, can't install.`
echo "" >> /home/sql/blog/crontab.bak

#以/home/sql/blog/crontab.bak作为crontab的任务列表文件并载入
...
crontab /home/sql/blog/crontab.bak
